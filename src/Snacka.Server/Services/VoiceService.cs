...
public class VoiceService : IVoiceService
{
    ...
    public VoiceService(SnackaDbContext db, ILogger<VoiceService> logger)
    {
        _db = db;
        _logger = logger;
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var targetChannel = await _db.Channels
            .FirstOrDefaultAsync(c => c.Id == targetChannelId && c.Type == Snacka.Shared.Models.ChannelType.Voice, cancellationToken);
