...
public class CommunityStoreTests : IDisposable
{
    ...
    public void RemoveCommunity_ClearsMembersForThatCommunity()
    {
        ...
        _store.AddCommunity(community);
        _store.SetMembers(communityId, new[] { CreateMember(userId: userId, username: "member1") });

        // Verify member exists before removal
        var memberBefore = _store.GetMember(userId);
        Assert.NotNull(memberBefore);

        // Act
        _store.RemoveCommunity(communityId);

        // Assert - member should be removed (using synchronous method)
        var memberAfter = _store.GetMember(userId);
    ...
    public void RemoveCommunity_ClearsSelectionIfSelected()
    {
        ...
        // Assert
        var selectedId = _store.SelectedCommunityId.WaitFirst();
    ...
    public void SelectedCommunity_ReturnsSelectedCommunityState()
    {
        ...
        // Assert
        var selected = _store.SelectedCommunity.WaitFirst();
    ...
    public void SetMembers_PopulatesMembersForCommunity()
    {
        ...
        // Assert
        var currentMembers = _store.CurrentCommunityMembers.WaitFirst();
    ...
    public void OnlineMembers_ReturnsOnlyOnlineMembers()
    {
        ...
        // Act
        var onlineMembers = _store.OnlineMembers.WaitFirst();
    ...
    public void OfflineMembers_ReturnsOnlyOfflineMembers()
    {
        ...
        // Act
        var offlineMembers = _store.OfflineMembers.WaitFirst();
    ...
    public void Clear_RemovesAllCommunitiesAndMembers()
    {
        ...
        // Assert
        var communities = _store.Items.WaitFirst();
        var selectedId = _store.SelectedCommunityId.WaitFirst();
