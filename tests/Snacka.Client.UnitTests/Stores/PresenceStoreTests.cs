...
public class PresenceStoreTests : IDisposable
{
    ...
    public void OnlineUserIds_ReturnsOnlyOnlineUsers()
    {
        ...
        // Act
        var onlineUserIds = _store.OnlineUserIds.WaitFirst();
    ...
    public void SetReconnectCountdown_UpdatesCountdown()
    {
        ...
        // Assert
        var seconds = _store.ReconnectSecondsRemaining.WaitFirst();
    ...
    public void Clear_RemovesAllUsersAndResetsStatus()
    {
        ...
        var status = _store.ConnectionStatus.WaitFirst();
        var reconnectSeconds = _store.ReconnectSecondsRemaining.WaitFirst();
